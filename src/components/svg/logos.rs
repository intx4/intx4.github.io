...
pub fn Github() -> Html {
    ...
    <path d="M128,12C60.8,12,6,66.8,6,134.4c0,54.2,35.1,100.2,83.7,116.5c6.1,1.1,8.4-2.7,8.4-6c0-2.9-0.1-10.5-0.2-20.6
            c-34,7.4-41.2-14.3-41.2-14.3c-5.5-13.9-13.5-17.6-13.5-17.6c-11.1-7.6,0.8-7.4,0.8-7.4c12.3,0.9,18.8,12.6,18.8,12.6
            c10.9,18.6,28.5,13.2,35.4,10.1c1.1-7.9,4.3-13.2,7.7-16.2c-27.1-3.1-55.6-13.6-55.6-60.5c0-13.4,4.8-24.4,12.6-33
            c-1.3-3.1-5.4-15.7,1.2-32.7c0,0,10.2-3.3,33.3,12.6c9.7-2.7,20.1-4,30.4-4c10.3,0,20.7,1.4,30.4,4c23.1-15.9,33.3-12.6,33.3-12.6
            c6.6,17,2.5,29.6,1.2,32.7c7.8,8.6,12.6,19.6,12.6,33c0,47-28.6,57.4-55.8,60.4c4.4,3.8,8.2,11.4,8.2,22.9
            c0,16.5-0.1,29.8-0.1,33.9c0,3.3,2.2,7.2,8.4,6c48.6-16.3,83.7-62.3,83.7-116.5C250,66.8,195.2,12,128,12z"/>
</svg>
    }
}
...
pub fn pdfIcon() -> Html {
    html! {
        <svg
            ...
            fill="#000000"
        >
            <rect x="8" y="8" width="48" height="56" rx="4" ry="4" fill="#f0f0f0" stroke="#c4c4c4" stroke-width="2" />
